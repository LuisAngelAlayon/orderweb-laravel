                                    ...
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="{{ route('auth.store') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <input type="name" class="form-control form-control-user" id="name" name="name" placeholder="Nombre Completo" required value="{{ old('name') }}">
                                            </div>
                                            <div class="form-group">
                                                <input type="email" class="form-control form-control-user" id="email" name="email" placeholder="Correo Electrónico" required value="{{ old('email') }}">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-user btn-block">REGISTARSE</button>
                                        </form>
                                        <hr>
                                        <div class="text-center">
